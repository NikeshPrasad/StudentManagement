	...
	<body>
		<div id="selectStudent" class="container">
			<div id="getEmployeeId">
				<h2>View Student</h2>
				<form name="getRollNo" action="getStudentByRollNoForSelect" onsubmit="return validateRollNo()">
					<label for="rollNo">Enter the roll number of the student you want to view:</label>
